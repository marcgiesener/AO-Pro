	<div id="sidebar">
		<div id="picture_Area">
			<span class="headstyle1"><img src="/images/photosheader.jpg" /></span>
				<div id="myGallery">
				<?php $photo_query = new WP_Query('cat=13&showposts=10'); ?>
		...
		<div id="films">
			...
			<div class="boxpadding">
				<?php $films_query = new WP_Query('cat=3&showposts=1'); ?>
				...
				<a href="../images/films.jpg"><span style="font-size:1.5em; font-weight:900; display:inline;">Download the Fall Films guide</span></a><a href="../films.pdf"><img style="display:inline" src="../images/PDF-Icon.jpg" width="30px" /></a>
			</div>
		</div>
